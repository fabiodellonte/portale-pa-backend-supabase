...
insert into segnalazioni (id, tenant_id, codice, titolo, descrizione, stato, priorita, severita, category_id, created_by, updated_at)
values
  ('20000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'SGN-DEMO-001', 'Buche via Roma', 'Manto stradale danneggiato vicino al civico 24.', 'in_attesa', 'alta', 'media', '10000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000111', now() - interval '1 day'),
  ('20000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'SGN-DEMO-002', 'Lampione spento in piazza', 'Illuminazione assente in piazza centrale dopo le 20:00.', 'presa_in_carico', 'media', 'media', '10000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000111', now() - interval '2 day'),
  ('20000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'SGN-DEMO-003', 'Rifiuti abbandonati al parco', 'Sacchi e materiali ingombranti vicino area giochi.', 'in_lavorazione', 'media', 'alta', '10000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000222', now() - interval '4 day');
